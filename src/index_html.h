...
const char page_monitor[] PROGMEM = R"rawliteral(
<!DOCTYPE html>
<html lang="pt-BR">
    <meta charset="UTF-8">
    <style>
    ...
    <body class="IndexBody">
        <div class="Header">
            ...
            <form action="/monitor-reset" method="get">
                <div class="SubmitButton">
                            ...
                            <div class="FormBody">
                                <form action="/get" method="get">
                                    <h2>Rede:
                                        ...
                                        <span id="ssid">-</span><br>
                                    </h2>
                                    <h2>IP Local:
                                        <label for="ipLocal"></label>
                                        <span id="ipLocal">-</span><br>
                                    </h2>
                                    <h2>Estado:
                                    ...
                                    <h2>RSSI:
                                        <label for="rssi"></label>
                                        <span id="rssi">-</span><br>
                                    </h2>
                                </form>
                            </div>
                        </div>
        ...
        <div class="Footer">
            <h2>Estado:
                <p>Indica o estado da conexão com o ponto de acesso armazenado (Rede).</p>
            </h2>
            <h2>RSSI:
                <p>A intensidade do sinal é representada pelo valor de RSSI (Received Signal Strenght Indicator). Quanto
                    menor o valor absoluto, melhor é a qualidade do sinal.</p>
            </h2>
            <h2>Conexão:
                <p>Indica o estado da conexão com a plataforma NodeIoT.</p>
            </h2>
        </div>
        <script>
            window.onload = function () {
                fetch('/monitor-data')
                    ...
                    .then(data => {
                        document.getElementById("ssid").textContent = data["Wi-Fi"]["ssid"];
                        document.getElementById("ipLocal").textContent = data["Wi-Fi"]["ipLocal"];
                        document.getElementById("state").textContent = data["Wi-Fi"]["state"];
                        ...
                        document.getElementById("connection").textContent = data["NodeIoT"]["connection"];
                    })
